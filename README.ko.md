...
Claude의 모든 모델에서 **출력 토큰 가격은 입력 토큰의 약 5배**입니다 — Sonnet 4.6은 입력 $3/M vs 출력 $15/M, Haiku 4.5는 $1/M vs $5/M, Opus 4.x는 $15/M vs $75/M. 비율은 어디서나 동일합니다. 응답이 두 배 길어진다고 비용이 두 배가 되는 게 아니라, 긴 절반이 청구서를 지배합니다.
